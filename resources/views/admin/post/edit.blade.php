            ...
            <div class="modal-body">
                <form action="{{ route('admin.blog.update', $blogs->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                       ...
                       {{-- <div class="col-12 mb-3">
                             <label class="form-label" for="basic-default-company">{{  __('Categories') }}</label>
                            <input type="text" value="{{ $blogs->categories->slug }}"  name="categories" class="form-control  @error('categories') is-invalid @enderror" id="basic-default-company" placeholder="" />
                            @error('categories')
                            <span class="invalid-feedback" role="alert">{{  $message  }}</span>
                            @enderror
                        </div> --}}
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea  id="body" name="description" class="form-control">{{ $blogs->description }}</textarea>
                        </div>
                    </div>
                    <div class="row g-2">
