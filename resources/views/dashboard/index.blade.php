                  ...
                  <div class="tab-content" id="profile-tabContent">
                                 ...
                                 <div class="col-md-6">
                                    <div class="profile__main-inner d-flex flex-wrap align-items-center">
                                       ...
                                       <div class="profile__main-content">
                                          <h4 class="profile__main-title">Welcome {{Auth::user()->name}}!</h4>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-md-6">
                                    <div class="profile__main-logout text-sm-end">
                                       <a class="tp-logout-btn" href="{{ route('logout') }}"
                              ...
                              <div class="row gx-3">
                                 ...
                                 <div class="col-md-3 col-sm-6">
                                    <div class="profile__main-info-item">
                                       <div class="profile__main-info-icon">
                                          <span>
                                             <span class="profile-icon-count profile-order">{{  getOrderItemCount() }}</span>
                                 ...
                                 <div class="col-md-3 col-sm-6">
                                    <div class="profile__main-info-item">
                                       <div class="profile__main-info-icon">
                                          <span>
                                             <span class="profile-icon-count profile-wishlist">{{ getWishlistItemCount()  }}</span>
                                 ...
                                 <div class="col-md-3 col-sm-6">
                                    <div class="profile__main-info-item">
                                       <div class="profile__main-info-icon">
                                          <span>
                                             <span class="profile-icon-count profile-wishlist">{{   getCartItemCount() }}</span>
                     ...
                     <div class="tab-pane fade" id="nav-information" role="tabpanel" aria-labelledby="nav-information-tab">
                        <div class="profile__info">
                           ...
                           <div class="profile__info-content">
                              <form action="{{ route('update-profile-page', Auth::user()->id)  }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                 <div class="row">
                                    <div class="col-xxl-12 col-md-12 py-4">
                                        <div class="profile__main-inner d-flex flex-wrap align-items-center">
                                            <div class="profile__main-thumb">
                                               <img src="{{ asset('profile/'.Auth::user()->image) }}" alt="">
                                               <div class="profile__main-thumb-edit">
                                                  <input id="profile-thumb-input" name="image" class="profile-img-popup" type="file">
                     ...
                     <div class="tab-pane fade" id="nav-password" role="tabpanel" aria-labelledby="nav-password-tab">
                        <div class="profile__password">
                           <form action="{{ route('change-password-page', Auth::user()->id) }}" method="POST">
                             @csrf
                             @method('put')
                              <div class="row">
                                 <div class="col-xxl-12">
                                    <div class="tp-profile-input-box">
                                       <div class="tp-contact-input">
                                          <input name="current_password" id="old_pass" type="password">
                                       </div>
