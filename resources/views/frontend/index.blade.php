...
@section('content')
    ...
    <!-- feature area start -->
    <section class="tp-feature-area pt-4 tp-feature-border-radius pb-70">
        <div class="container">
                    ...
                    <div class="tp-product-tab-content">
                        <div class="tab-content" id="myTabContent">
                                                ...
                                                <div class="tp-product-item p-relative transition-3 mb-25">
                                                    ...
                                                    <div class="tp-product-content">
                                                        <div class="tp-product-category">
                                                            <a href="/shop">{{ $product->subCategory->name }}</a>
                                                        </div>
                            ...
                            <div class="tab-pane fade" id="topsell-tab-pane" role="tabpanel"
                                ...
                                <div class="row">
                                    @if ($sellingproduct->isNotEmpty())
                                        @foreach ($sellingproduct as $product)
                                            <div class="col-xl-3 col-lg-3 col-sm-6">
                                                <div class="tp-product-item transition-3 mb-25">
                                                    <div class="tp-product-thumb p-relative fix m-img">
                                                        <a href="{{ route('product-single', $product->slug) }}">
            ...
            <div class="row">
                    ...
                    <div class="tp-banner-item tp-banner-height p-relative mb-30 z-index-1 fix">
                        ...
                        <div class="tp-banner-content">
                            ...
                            <h3 class="tp-banner-title">
                                <a href="/shop">Smartphone <br> BLU G91 Pro 2022</a>
                            </h3>
                            <div class="tp-banner-btn">
                                <a href="/shop" class="tp-link-btn">Shop Now
                ...
                <div class="col-xl-4 col-lg-5">
                    <div class="tp-banner-item tp-banner-item-sm tp-banner-height p-relative mb-30 z-index-1 fix">
                        ...
                        <div class="tp-banner-content">
                            <h3 class="tp-banner-title">
                                <a href="/shop">HyperX Cloud II <br> Wireless</a>
                            </h3>
                            <p>Sale 35% off</p>
                            <div class="tp-banner-btn">
                                <a href="/shop" class="tp-link-btn">Shop Now
                ...
                <div class="col-xl-4 col-lg-5">
                    <div class="tp-product-gadget-sidebar mb-40">
                        <div class="tp-product-gadget-categories p-relative fix mb-10">
                            ...
                            @foreach ($categor as $categorie)
                                <h3 class="tp-product-gadget-categories-title">{{ $categorie->name }} <br> Gadgets</h3>
                                <div class="tp-product-gadget-categories-list">
                                    @foreach ($categorie->subcategories as $item)
                                        <ul>
                                            <li><a href="{{ route('shop-page') }}">{{ $item->name }}</a></li>
                                        </ul>
                                    @endforeach
                                </div>

                                <div class="tp-product-gadget-btn">
                                    <a href="{{ route('shop-page') }}" class="tp-link-btn">More Products
                                        <svg width="15" height="13" viewBox="0 0 15 13" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M13.9998 6.19656L1 6.19656" stroke="currentColor" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                    ...
                                    <div class="tp-product-gadget-banner-item swiper-slide include-bg"
                                        ...
                                        <div class="tp-product-gadget-banner-content">
                                            ...
                                            <h3 class="tp-product-gadget-banner-title">
                                                <a href="/shop">Selected novelty <br> Products</a>
                                            </h3>
                                        </div>
                                    </div>
                                    <div class="tp-product-gadget-banner-item swiper-slide include-bg"
                                        ...
                                        <div class="tp-product-gadget-banner-content">
                                            ...
                                            <h3 class="tp-product-gadget-banner-title">
                                                <a href="/shop">Top Rated <br> Products</a>
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6 col-lg-6">
                                    <div class="tp-product-banner-content p-relative z-index-1">
                                        ...
                                        <div class="tp-product-banner-btn">
                                            <a href="/shop" class="tp-btn tp-btn-2">Shop now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6">
                                    <div class="tp-product-banner-thumb-wrapper p-relative">
                                        <div class="tp-product-banner-thumb-shape">
                                            ...
                                            <img class="tp-offer-shape" src="assets/img/banner/banner-slider-offer.png"
                                                alt="">
                                        </div>
                            ...
                            @foreach ($discount_products as $products)
                                <div class="tp-product-sm-item d-flex align-items-center">
                                    ...
                                    <div class="tp-product-sm-content">
                                        <div class="tp-product-category">
                                            <a href="/shop">{{ $products->subCategory->name }}</a>
                                        </div>
                                        <h3 class="tp-product-title">
                                            <a href="{{  route('product-single', $products->slug)  }}">
                                                {{ \Str::limit($products->name, 20) }}
                                            </a>
                                        </h3>
                                        <div class="tp-product-rating d-sm-flex align-items-center">
                                            ...
                                            <div class="tp-product-rating-text">
                                                <span>({{ $products->reviews }} Review)</span>
                                            </div>
                                        </div>
                                        <div class="tp-product-price-wrapper">
                            ...
                            @foreach ($featured_products as $products)
                                <div class="tp-product-sm-item d-flex align-items-center">
                                    <div class="tp-product-thumb mr-25 fix">
                                        <a href="{{  route('product-single', $products->slug) }}">
                                            <img src="{{ asset('storage/product/' . $products->cover_image) }}"
                                                width="125" alt="{{ \Str::limit($products->name, 20) }}">
                                        </a>
                                    </div>
                                    <div class="tp-product-sm-content">
                                        <div class="tp-product-category">
                                        ...
                                        <h3 class="tp-product-title">
                                            <a href="{{  route('product-single', $products->slug) }}">{{ \Str::limit($products->name, 20) }}</a>
                                        </h3>
                                        <div class="tp-product-rating d-sm-flex align-items-center">
                                            <div class="tp-product-rating-icon">
                                                @for ($i = 0; $i < 5; $i++)
                        ...
                        <div class="tp-product-sm-wrapper mr-20">
                            @foreach ($sellingproduct as $product)
                                <div class="tp-product-sm-item d-flex align-items-center">
                                    <div class="tp-product-thumb mr-25 fix">
                                        <a href="{{  route('product-single', $product->slug) }}">
                                            <img src="{{ asset('storage/product/' . $product->cover_image) }}" width="125"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="tp-product-sm-content">
                                        ...
                                        <h3 class="tp-product-title">
                                            <a href="{{  route('product-single', $product->slug) }}">{{ \Str::limit($product->name, 20) }}</a>
                                        </h3>
                                        <div class="tp-product-rating d-sm-flex align-items-center">
                                            <div class="tp-product-rating-icon">
                                                @for ($i = 0; $i < 5; $i++)
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="tp-blog-more-2 mt-10 text-center">
                        <a href="#" class="tp-btn tp-btn-border tp-btn-border-sm">Discover More</a>
                    </div>
                </div>
            </div>
        </div>
