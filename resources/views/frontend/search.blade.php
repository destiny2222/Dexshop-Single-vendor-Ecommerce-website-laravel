          ...
          <div class="row">
             <div class="col-xxl-12">
                <div class="breadcrumb__content p-relative z-index-1">
                   <h3 class="breadcrumb__title">Search for "{{ $query }}"</h3>
            ...
            @foreach ($product as $products)
             <div class="col-lg-4 col-sm-6">
                <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                   <div class="tp-category-main-thumb include-bg transition-3" data-background="{{  asset('storage/product/'.$products->cover_image) }}"></div>
          ...
          <div class="row">
             <div class="col-xl-12">
                <div class="tp-category-main-more text-center">
                   <a href="/shop" class="tp-load-more-btn">
                      Load More
