                           ...
                           <div class="tp-shop-widget-content">
                              <div class="tp-shop-widget-categories">
                                @foreach ($subcategories as $category)
                                    <ul>
                                        <li><a href="{{  route('product-details', $category->slug) }}">{{ $category->name }} <span>{{  $count  }}</span></a></li>
                                    </ul>
                                @endforeach
                              </div>
                           </div>
                                 ...
                                 @for ($i = 0; $i < $product->ratings->count(); $i++)
                                    <div class="tp-shop-widget-product-item d-flex align-items-center">
                                        ...
                                        <a href="{{ route('product-single', $product->slug) }}">
                                            <img src="{{ asset('storage/product/'.$product->cover_image) }}" alt="">
                                        </a>
                                        </div>
                                        <div class="tp-shop-widget-product-content">
                                            ...
                                            <div class="tp-shop-widget-product-price-wrapper">
                                                <span class="tp-shop-widget-product-price">{{ number_format($product->price,2) }}</span>
                                            </div>
                                        </div>
                                    </div>
                                  @endfor
                                                ...
                                                <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                    ...
                                                    <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                        <div class="tp-product-action-item-2 d-flex flex-column">
                                                            ...
                                                            <button type="button" class="tp-product-action-btn-2 tp-product-quick-view-btn" data-bs-toggle="modal" data-bs-target="#producQuickViewModal{{ $item->slug }}">
